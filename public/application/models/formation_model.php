...
class Formation_model extends CI_Model {
	...
	var $column_search = array('libelle','domaine.nom','domaine.nom','filiere.nom'); //set column field database for datatable searchable just firstname , lastname , address are searchable
