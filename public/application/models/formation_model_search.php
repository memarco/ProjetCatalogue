...
class formation_model_search extends CI_Model {
    ...
    public function record_count($key) {
        return $this->db->from('rd_formation')
                        ...
                        ->join('type_formation', 'type_formation.id = rd_formation.id_type_formation')
    ...
    public function get_formation_by_filter($id = FALSE, $limit, $start,$key,$id_type_formation,$id_domaine,$id_composante,$id_filiere,$id_diplome,$id_site,$regex_alternance,$id_type_stage) {
        ...
        //    $this->db->limit($limit, $start);}
            ...
            if($regex_alternance != 0){
            $this->db->where('rd_formation.regex_alternance', $regex_alternance);}
            if($id_filiere != 0){
    ...
    public function get_regex_alt() {
        $this->db->select('regex_alternance');
        $this->db->from('rd_formation');
        $this->db->order_by("regex_alternance", "desc");
