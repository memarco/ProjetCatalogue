...
class Formation extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('formation_model','person');
	}
	...
	public function ajax_list()
	{
		...
		foreach ($list as $person) {
			...
			//add html for action
			$row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Afficher" onclick="edit_person('."'".$person->id."'".')"><i class="glyphicon glyphicon-search"></i> Voir</a>
				  ';
