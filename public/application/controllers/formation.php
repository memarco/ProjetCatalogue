...
class formation extends CI_Controller {
    ...
    public function get_formation()
    {
        ...
        $id_type_stage=$_REQUEST['id_type_stage'];
        $id_rythme=$_REQUEST['id_rythme'];

        $list = $this->formation_model->get_formation_by_filter($id_type_formation,$id_domaine,$id_composante,$id_filiere,$id_diplome,$id_site,$id_type_stage,$id_rythme,$key) ;
        $data = array();
        foreach ($list as $person) {
            ...
            /*$row[] = $person->nom_d;
            $row[] = $person->nom_s;
            $row[] = "<b>$stage</b>".$person->regex_stage."<br/><b>$alternance</b>".$person->regex_alternance;*/
            //add html for action
    ...
    public function get_formation_by_id(){
        ...
        $list = $this->formation_model->get_formation_by_id($id_formation) ;
        $data = array();
        foreach ($list as $person) {
            $stage ='';
            $alternance='';
