    ...
    <div class="row">
        ...
        <?php $this->load->view('templates/head_form') ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="col-sm-10">
                    <div  class="btn-group" >
                        <label  class="btn btn-default"><input type="radio" name="est_alternance" value="1" id="oui_alternance"> OUI</label>
                        <label  class="btn btn-default  active"><input type="radio" name="est_alternance" value="0" id="non_alternance"   checked > NON</label>
                    </div>
                    </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" id="email" class="form-control" value="<?php echo set_value('mention'); ?>" name="mention">
