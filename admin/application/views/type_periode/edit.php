...
<div class="container">
    ...
    <div class="row">
        ...
        <?php $this->load->view('templates/head_form') ?>
                    ...
                    <?php echo form_open('type_periode/edit/' . $type_periode_item['id']); ?>
                    <div class="form-group">
                        <label for="title" class="col-sm-2 control-label">Nom</label>
                        <div class="col-sm-10">
                            <input type="input" id="email" class="form-control" name="nom" value="<?php echo $type_periode_item['nom'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-2 col-sm-3">
                            <a class="btn btn-danger btn-block" href="<?php echo site_url('type_periode/'); ?>" role="button">Annuler</a>
                        </div>
                    </div>
                    </form>
